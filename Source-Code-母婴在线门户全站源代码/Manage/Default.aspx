...
<script src="/JS/ICMS/FrameTab.js?version=<%:ZoomLa.BLL.BLLCommon.Version_JS %>"></script>
    ...
    <div class="newbody" id="newbody" style="display: none;" ondblclick="$(this).hide();">
        <div class="newbody_t">
            <div class="newbody_tl ">
                ...
                <div runat="server" id="newbody_logo2" visible="false"><span class="logo3"><%=ComRE.Img_NoPic(ZoomLa.Components.SiteConfig.SiteInfo.LogoAdmin, "zllogo10") %></div>
                    <span class="logo4"><%=ZoomLa.Components.SiteConfig.SiteInfo.LogoPlatName.Split('<')[0] %></span></span>
                <a href="#" onclick="javascript:$('.newbody').hide();showleft('menu1_1','{$path}Site/SiteConfig.aspx')">门户管理</a>
                <a href="#" onclick="javascript:$('.newbody').hide();showleft('menu1_1','{$path}WorkFlow/OAConfig.aspx')">办公平台</a>
                <a href="#" onclick="javascript:$('.newbody').hide();showleft('menu1_1','{$path}Content/ECharts/AddChart.aspx')">数据管理</a>
                <a href="#" onclick="javascript:$('.newbody').hide();showleft('menu10_1','/APP/Default')">移动开发</a>
                <a href="#" onclick="javascript:$('.newbody').hide();showleft('menu10_1','WeiXin/home.aspx')">微信应用</a>
            </div>
        ...
        <div class="newbody_c"><i class="<%:string.IsNullOrEmpty(ZoomLa.Components.SiteConfig.SiteInfo.LogoAdmin)?"fa ZoomlaICO2015":ZoomLa.Components.SiteConfig.SiteInfo.LogoAdmin %> animated"></i> </div>
...
<i class="fa z01-icon106"></i>
</button>
	<div class="navbar-collapse collapse in show" id="navbarsExampleDefault" aria-expanded="false">
	<a  class="sys_index_Close" href="javascript:;" onclick="ul_hidew();"><i class="fa z01-icon107"></i> </a>
	...
	<ul class="nav navbar-nav" id="nav_myTopnav">
		...
		<li class="nav-item menu11 sys_index_outbtn"><a href="/AdminMVC/COM/Logout"><i class="fa z01-icon153"></i> 退出</a></li>
	</ul>
	</div>	
</nav>
...
<div class="input-group input-group-sm"><asp:TextBox runat="server" ID="keyText" class="form-control" placeholder="快速检索" onkeydown="return IsEnter(this);" style="color:#fff;"/>
<i class="fa fa-search" onClick="SearchPage();"></i> </div>
</div>
...
<a class="max_768_none" href="javascript:;" onClick="ShowManageLeft();"><i class="fa z01-icon106"></i> </a>
</div>
</div>
<!--主菜单end-->
...
<div class="m_top_bottom nav-scroller">
	<ul class="menu1 open nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu1_5" onclick="showleft('menu1_1','Workload/FuncList.aspx')">功能列表</a></li>
	...
	<ul class="menu2 open nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu2_2 " onclick="ShowMain('NodeTree.ascx','Content/SpecialManage.aspx')"><%=Resources.L.按专题管理 %></a></li>
        <li><a class="nav-link menu2_3" onclick="showleft('menu2_3','Content/CommentManage.aspx')">评论写作</a></li>
		<!--<li><a class="nav-link menu2_4" onclick="showleft('menu2_4','Pub/PubManage.aspx')"><%=Resources.L.互动模块 %></a></li>-->
		<li>
			<div class="btn-group sys_posit_in menu2_4">
			<button type="button" class="btn m_top_bottom_deropLeft" onclick="showleft('menu2_4','Pub/PubManage.aspx')"><%=Resources.L.互动模块 %></button>
				<button type="butt	on" class="btn m_top_bottom_deropRight dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="sr-only">Toggle Dropdown</span></button>
			  <div class="dropdown-menu sys_inde_dropdown">
				<a class="dropdown-item" href="javascript:;" onclick="showleft('menu2_4','Pub/PubManage.aspx')"><%=Resources.L.互动模块 %></a>
				...
				<a class="dropdown-item" href="javascript:;" onclick="showleft('menu2_4','Pub/PubRecycler.aspx')"><%=Resources.L.互动存档 %></a></a>
	...
	<ul class="menu3 nav nav-underline sys_overhid">
        ...
        <li class="menu3_13">
			<div class="btn-group sys_posit_in">
				...
				<button type="button" class="btn m_top_bottom_deropRight dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="sr-only">Toggle Dropdown</span></button>
				<div class="dropdown-menu sys_inde_dropdown">
					<a class="dropdown-item" href="javascript:;" data-url="UserShopManage/StoreManage.aspx">店铺审核</a>
					<a class="dropdown-item" href="javascript:;" data-url="UserShopManage/StoreStyle.aspx">店铺样式</a>
					<a class="dropdown-item" href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=5">商品模型</a>
					<a class="dropdown-item" href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=6">申请模型</a>
					<a class="dropdown-item" href="javascript:ShowMain('UserShopNodeTree.ascx','Shop/ProductManage.aspx?StoreID=-1',this);">商品管理</a>
				</div>
			</div>
		</li>
      </ul>	
	<ul class="menu4 nav nav-underline sys_overhid">
        <li><a class="nav-link active menu4_2 " onclick="showleft('menu4_2','/AdminMVC/Page/ApplyAudit')">黄页管理</a></li>
        <li><a class="nav-link menu4_4" onclick="ShowMain('PageTree.ascx','/AdminMVC/Page/PageContent')">内容管理</a></li>
        <li><a class="nav-link menu4_5" onclick="showleft('menu4_5','Content/Model/ModelManage.aspx?ModelType=10')">模型管理</a></li>
        <li><a class="nav-link menu4_4" onclick="showleft('menu4_2','/AdminMVC/Page/PageTemplate?ID=-1')">公用栏目</a></li>
        <li><a class="nav-link menu4_7" onclick="showleft('menu4_2','/AdminMVC/Page/PageConfig')">黄页配置</a></li>
      </ul>
	  ...
	  <ul class="menu5 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu5_10" onclick="showleft('menu5_10','//v.ziti163.com')">字体大师</a></li>
	...
	<ul class="menu6 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu9_8" onclick="showleft('menu6_9','User/Addon/UserGraph.aspx')">用户画像</a></li>
      </ul>
	...
	<ul class="menu7 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu7_3" onclick="showleft('menu7_3','Counter/Counter.aspx')"><%=Resources.L.访问统计 %></a></a></li>
        ...
        <li><a class="nav-link menu7_8" onclick="showleft('menu7_8','Copyright/Config.aspx')">版权中心</a></li>
        <li><a class="nav-link menu8_10" onclick="showleft('menu8_10','Addon/Plugins/Default.aspx')">插件管理</a></li>
	...
	<ul class="menu8 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu10_7" onclick="showleft('menu10_7','Amazing/css/Default.aspx')">百变微站</a></li>
        <li><a class="nav-link menu8_9" onclick="showleft('menu10_7','Addon/FontIcon/Default.aspx')">字库与图标</a></li>
        <li><a class="nav-link menu8_8" onclick="showleft('menu8_8','Pay/PayPlatManage.aspx')">支付中心</a></li>
      </ul>
	  ...
	  <ul class="menu9 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu9_2" onclick="ShowMain('StructTree.ascx','AddOn/StructList.aspx')"><%=Resources.L.组织结构 %></a></li>
        <li><a class="nav-link menu9_9" onclick="showleft('menu9_9','Plat/PlatInfoManage.aspx')"><%=Resources.L.能力中心 %></a></a></li>
	  ...
	  <ul class="menu10 nav nav-underline sys_overhid">
        <li><a class="nav-link active menu10_6 " onclick="showleft('menu10_6','Design/SceneList.aspx')">H5创作</a></li>
        <li><a class="nav-link menu10_1" onclick="showleft('menu10_1','WeiXin/home.aspx')"><%=Resources.L.移动应用 %></a></li>
        <li><a class="nav-link menu10_2" onclick="ShowMain('Weixin.ascx','WeiXin/home.aspx');">微信应用</a></a></li>
        <li><a class="nav-link menu10_5" onclick="showleft('menu10_5','TouTiao/TouTiaoContent.aspx');">头条管理</a></li>
        <li><a class="nav-link menu10_3" onclick="showleft('menu10_1','/Tools/Mobile.aspx')"><%=Resources.L.移动浏览器 %></a></li>
        <li><a class="nav-link menu10_4" onclick="showleft('menu10_3','Shop/Printer/ListDevice.aspx')">智能硬件</a></li>
        <li><a class="nav-link menu10_5" onclick="showleft('menu10_4','Mobile/Push/APIList.aspx')">消息推送</a></li>
      </ul>
	...
	<ul class="menu11 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link menu11_3" onclick="showleft('menu11_1','Site/DBManage.aspx')"><%=Resources.L.数据库管理 %></a></a></li>
        <li><a class="nav-link menu11_4" onclick="showleft('menu11_1','Site/Default.aspx')">IIS站点</a></li>
        ...
        <li><a class="nav-link menu11_10" onclick="showleft('menu11_10','design/SiteList.aspx')">动力设计</a></li>
      </ul>	
</div>
<!--子菜单end-->
...
<div id="menu1" class="m_left_ul open">
	<ul id="menu1_1" class="m_left_ulin open">
		<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.便捷菜单 %> </li>
	...
	<ul id="menu1_2" class="m_left_ulin">
		<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.便捷导航 %> </li>
		<div class="input-group">
		 <input type="text" id="searchkeyword" class="form-control" onkeydown="return ASCX.OnEnterSearch('Guest/AllSearch.aspx?keyWord=',this);" placeholder="<%=Resources.L.导航标题 %>" />
		  ...
		  <button class="input-group-text" type="button" onclick="ASCX.Search('Config/FuncSearch.aspx?keyWord=','searchkeyword');"><i class="fa fa-search"></i>
		  </div>
		</div>
		<li id="menu1_2_1"><a href="javascript:;" data-url="Config/SearchFunc.aspx"><%=Resources.L.管理导航 %></a></li>
				...
				<ul id="menu1_3" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.修改密码 %> </li>
			...
			<div id="menu2" class="m_left_ul">
				...
				<ul class="m_left_ulin" id="menu2_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.评论管理 %> </li>
					<li id="menu2_3_1"><a href="javascript:;" data-url="Content/CommentManage.aspx"><%=Resources.L.评论管理 %></a></li>
					<li id="menu2_3_4"><a href="javascript:;" data-url="/AdminMVC/Content/MarkDown">MarkDown写作</a></li>
				...
				<ul class="m_left_ulin" id="menu2_4">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.互动模块 %></li>
				...
				<ul class="m_left_ulin" id="menu2_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.采集检索 %></li>
				...
				<ul class="m_left_ulin" id="menu2_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.视频管理 %></li>
				...
				<ul class="m_left_ulin" id="menu2_7">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.生成发布 %></li>
				...
				<ul class="m_left_ulin" id="menu2_9">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.百科问答 %></li>
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-arrow-circle-down"></i> <%=Resources.L.论坛留言 %></p>
						<ul>
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-arrow-circle-down"></i> <%=Resources.L.问答管理 %></p>
						<ul>
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-arrow-circle-down"></i> <%=Resources.L.百科管理 %></p>
						<ul>
							<li id="menu2_9_9"><a href="javascript:;" data-url="Guest/BKVersionList.aspx?Status=-100">词条版本</a></li>
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button class="input-group-text" type="button" onclick="ASCX.Search('Guest/AllSearch.aspx?keyWord=','tiekeyword');"><i class="fa fa-search"></i></button>
						</div>
					</div>
				</ul>
				<ul class="m_left_ulin" id="menu2_10">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.内容参数 %></li>
			...
			<div id="menu3" class="m_left_ul">
				...
				<ul id="menu3_2" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.库存管理 %></li>
				...
				<ul id="menu3_3" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.订单管理 %></li>
					<li id="menu3_3_2"><a href="javascript:;" data-url="Shop/OrderList.aspx">订单列表</a></li>
					<li id="menu3_3_6" role="presentation" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">其它扩展 <span class="caret"></span>
						</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=10">代购订单</a></li>
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=1">酒店订单</a></li>
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=2">机票订单</a></li>
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=3">旅游订单</a></li>
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=5">域名订单</a></li>
							<li><a href="javascript:;" data-url="Shop/OrderList.aspx?OrderType=11">捐赠订单</a></li>
						</ul>
					</li>
					<li id="menu3_3_21"><a href="javascript:;" data-url="Shop/Addon/ProOrder/Default.aspx">申购订单</a></li>
					<li id="menu3_3_19"><a href="javascript:;" data-url="Shop/OrderRepairAudit.aspx">返修退货</a></li>
					<li id="menu3_3_20"><a href="javascript:;" data-url="Shop/Addon/After/SettleList.aspx">订单结算</a></li>
					<li id="menu3_3_11"><a href="javascript:;" data-url="Shop/FillOrder.aspx">补录订单</a></li>
					<li id="menu3_3_5"><a href="javascript:;" data-url="Shop/OrderSql.aspx">账单管理</a></li>
					...
					<li id="menu3_3_1"><a href="javascript:;" data-url="Shop/CartManage.aspx">购物车记录</a></li>
					<li id="menu3_3_16"><a href="javascript:;" data-url="Shop/SystemOrderModel.aspx?Type=1">购物车模型</a></li>
				</ul>
				<ul id="menu3_4" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.明细记录 %></li>
				...
				<ul id="menu3_5" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.销售统计 %></li>
<%--					<li id="menu3_5_1"><a href="javascript:;" data-url="/AdminMVC/Sale/SaleByDay">按日统计</a></li>
				...
				<ul id="menu3_6" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.促销优惠 %></li>
					<li id="menu3_6_1"><a href="javascript:;" data-url="Shop/Arrive/GroupPro.aspx">单品组合</a></li>
					<li id="menu3_6_2"><a href="javascript:;" data-url="Shop/Arrive/SuitPro.aspx">促销组合</a></li>
					<li id="menu3_6_4"><a href="javascript:;" data-url="Shop/Arrive/PromoList.aspx">促销列表</a></li>
				...
				<ul id="menu3_7" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.商城配置 %></li>
					<li id="menu3_7_1"><a href="javascript:;" data-url="Shop/Addon/exp/DeliverType.aspx"><%=Resources.L.运费模板 %></a></li>
					<li id="menu3_7_2"><a href="javascript:;" data-url="Shop/AddOn/ExpSenderManage.aspx">发件信息</a></li>
					...
					<li id="menu3_7_8"><a href="javascript:;" data-url="Shop/Addon/Material/Default.aspx">原料管理</a></li>
				</ul>
				<ul id="menu3_8" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.推广中心 %></li>
		...
		<ul>
			...
			<!--<li id="menu3_8_11"><a href="javascript:;" data-url="Shop/profile/LmUserManage.aspx">联盟会员</a></li>-->
				...
				<ul id="menu3_9" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.商品回收站 %></li>
					<li id="menu3_9_1"><a href="javascript:;" data-url="Shop/ShopRecycler.aspx"><%=Resources.L.商品回收站 %></a></li>
				</ul>
				<ul id="menu3_10" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i>IDC管理</li>     
				...
				<ul id="menu3_13" class="m_left_ulin">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.店铺管理 %></li>
					<li id="menu3_13_1"><a href="javascript:;" data-url="UserShopManage/StoreManage.aspx">店铺管理</a></li>
					<li id="menu3_13_2"><a href="javascript:;" data-url="UserShopManage/StoreStyle.aspx">店铺样式</a></li>
					<li id="menu3_13_3"><a href="javascript:ShowMain('UserShopNodeTree.ascx','Shop/ProductManage.aspx?StoreID=-1',this);">店铺商品</a></li>
					<li id="menu3_13_4"><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=6">申请模型</a></li>
					<li id="menu3_13_5"><a href="javascript:;" data-url="UserShopManage/ShopMailConfig.aspx">邮件管理</a></li>
					<li id="menu3_13_6"><a href="javascript:;" data-url="UserShopManage/DeliveryMan.aspx">送货员</a></li>
				</ul>
			</div>
			<div id="menu4" class="m_left_ul">
				<ul class="m_left_ulin" id="menu4_2">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 黄页管理</li>
					<li id="menu4_2_1"><a href="javascript:;" data-url="/AdminMVC/Page/ApplyAudit"><%=Resources.L.黄页审核 %></a></li>
					<li id="menu4_2_3"><a href="javascript:;" data-url="/AdminMVC/Page/PageStyle">黄页样式</a></li>
					<li id="menu4_2_5"><a href="javascript:;" data-url="/AdminMVC/Page/PageConfig"><%=Resources.L.黄页配置 %></a></li>
				</ul>
				<ul class="m_left_ulin" id="menu4_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.黄页模型管理 %></li>
					<li id="menu4_5_2"><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=10">黄页申请模型</a></li>
					<li id="menu4_5_1"><a href="javascript:;" data-url="Content/Model/ModelManage.aspx?ModelType=4">黄页内容模型</a></li>
				</ul>
			</div>
			<div id="menu5" class="m_left_ul">
				<ul class="m_left_ulin" id="menu5_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.考试管理 %></li>
					<li id="menu5_1_2"><a href="javascript:;" data-url="/AdminMVC/Exam/CourseManage"><%=Resources.L.课程管理 %></a></li>
					<li id="menu5_1_4"><a href="javascript:;" data-url="/AdminMVC/Exam/Question_Class_Manage">科目管理</a></li>
					<li id="menu5_1_5"><a href="javascript:;" data-url="/AdminMVC/Exam/ExamPointManage"><%=Resources.L.考点管理 %> </a></li>
					<li id="menu5_1_3"><a href="javascript:;" data-url="/AdminMVC/Exam/ToScore">阅卷中心 </a></li>
				</ul>
				<ul class="m_left_ulin" id="menu5_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.排课管理 %></li>
					...
					<!-- <li class="menu5_3_4"><a href="javascript:;" data-url="AddCRM/CustomerList.aspx?usertype=0">学员管理</a></li> -->
				</ul>
				<ul class="m_left_ulin" id="menu5_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.财务管理 %></li>
				...
				<li class="menu_tit"><i class="fa fa-chevron-down"></i> 组卷配置</li>

				<div class="input-group ">
				<input type="text" placeholder="<%=Resources.L.试题名 %>" class="form-control" id="question_text" />
				<div class="input-group-append">
					<a href="javascript:;" data-url="" onclick="$(this).attr('data-url','Exam/QuestionManage.aspx?KeyWord='+$('#question_text').val());" class="input-group-text"><i class="fa fa-search"></i></a>
				</div>
				</div>
					<li id="menu5_7_3 "><a href="javascript:;" data-url="/AdminMVC/Exam/Setting"><%=Resources.L.配置中心 %></a></li>
					<%--<li id="menu5_7_1"><a href="javascript:;" data-url="/AdminMVC/Exam/Paper_Class_Manage"><%=Resources.L.试卷节点 %></a></li>--%>
				...
				<ul class="m_left_ulin" id="menu5_10">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 字体管理</li>
					<li id="menu5_10_1"><a href="javascript:;" data-url="Content/Font/Default.aspx">字库列表</a></li>
				</ul>
			</div>
			<div id="menu6" class="m_left_ul">
				<ul class="m_left_ulin" id="menu6_1">test</ul>
				<ul class="m_left_ulin" id="menu6_2">			
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.管理员管理 %></li>
					<div class="input-group">
						...
						<div class="input-group-append">
							<button id="Ok" class="input-group-text" type="button" onclick="ASCX.Search('User/AdminManage.aspx?keyWordss=','keyWordss');"><i class="fa fa-search"></i></button>
						</div>
					</div>
				...
				<ul class="m_left_ulin" id="menu6_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.用户角色 %></li>
				...
				<ul class="m_left_ulin" id="menu6_4">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.信息发送 %></li>
				...
				<ul class="m_left_ulin" id="menu6_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.订阅中心 %></li>
				...
				<ul class="m_left_ulin" id="menu6_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.人才招聘 %></li>
				...
				<ul class="m_left_ulin" id="menu6_7">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.SNS社区模块 %></li>
				...
				<ul class="m_left_ulin" id="menu6_8">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.整合接口%></li>
					...
					<li class="menu6_8_8"><a href="javascript:;" data-url="Config/Third/PlatInfoList.aspx">平台接口</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu6_9">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 用户画像</li>
					<li class="menu6_9_1"><a href="javascript:;" data-url="User/Addon/UserGraph.aspx">概览</a></li>
				</ul>
			</div>
			<div id="menu7" class="m_left_ul">
				<ul class="m_left_ulin" id="menu7_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.开发中心%></li>
					<li id="menu7_1_12"><a href="javascript:;" data-url="Config/DBTools/Default.aspx">数据管理维护</a></li>
					<li id="menu7_1_1"><a href="javascript:;" data-url="Config/DBTools/CreateTable.aspx"><%=Resources.L.快速智能建表%></a></li>
					<li id="menu7_1_14"><a href="javascript:;" data-url="Config/DBTools/TableToExcel.aspx">数据导出Excel</a></li>
				...
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> 广告管理</p>
					<ul>
					...
					<li id="menu7_2_3"><a href="javascript:;" data-url="Plus/ADAdbuy.aspx">广告申请</a></li>
					<li id="menu7_2_4"><a href="javascript:;" data-url="Content/ECharts/Default.aspx">图表管理</a></li>
					</ul>
					</li>
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> 名片设计</p>
						<ul>
							<li id="menu7_2_7"><a href="javascript:;" data-url="Plus/Logo/IconList.aspx">图标管理</a></li>
							<li id="menu7_2_5"><a href="javascript:;" data-url="Plus/Logo/DesTlpList.aspx">名片模板</a></li>
							<li id="menu7_2_6"><a href="javascript:;" data-url="Plus/Logo/DesList.aspx">用户作品</a></li>
						</ul>
					</li>
			  <%--      <li id="menu7_2_9"><a href="javascript:;" data-url="/Plugins/Flex/Default.aspx"><%=Resources.L.在线设计%></a></li>--%>
				...
				<ul class="m_left_ulin" id="menu7_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.访问统计%></li>
				...
				<ul class="m_left_ulin" id="menu7_4">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.问卷调查%></li>
				...
				<ul class="m_left_ulin" id="menu7_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.文件管理%></li>
				...
				<ul class="m_left_ulin" id="menu7_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.数据字典%></li>
					...
					<li id="menu7_6_4"><a href="javascript:;" data-url="Addon/KeyWordManage.aspx">搜索关键词库</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu7_8">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 版权中心</li>
			...
			<div id="menu8" class="m_left_ul">
				<ul class="m_left_ulin" id="menu8_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.网站配置%></li>
				...
				<ul class="m_left_ulin" id="menu8_2">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.模型管理%></li>
				...
				<ul class="m_left_ulin" id="menu8_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.节点管理%></li>
					...
					<div class="input-group">
						<input type="text" id="NodeSkey_t" class="form-control" placeholder="节点ID或名称" onkeydown="return ASCX.OnEnterSearch('Content/Node/NodeSearch.aspx?NodeID=',this);" />
						<div class="input-group-append">
							<button id="NodeBtn" class="input-group-text" type="button" onclick="ASCX.Search('Content/Node/NodeSearch.aspx?NodeID=','NodeSkey_t');"><i class="fa fa-search"></i></button>
						</div>
					</div>
				</ul>
				<ul class="m_left_ulin" id="menu8_4">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.流程管理%></li>
				...
				<ul class="m_left_ulin" id="menu8_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.专题管理%></li>
					...
					<div class="input-group">
						...
						<div class="input-group-append">
							<button id="Spec_btn" class="input-group-text" type="button" onclick="ASCX.Search('Content/SpecialManage.aspx?skey=','SpecKey_t');"><i class="fa fa-search"></i></button>
						</div>
					</div>
				</ul>
				<ul class="m_left_ulin" id="menu8_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.模板风格%></li>
					...
					<li id="menu8_6_4"><a href="javascript:;" data-url="Template/TemplateSetOfficial.aspx">云端模板</a></li>
				...
				<ul class="m_left_ulin" id="menu8_8">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.在线支付%></li>
					...
					<li id="menu8_8_9"><a href="javascript:;" data-url="Pay/PaypalManage.aspx">PayPal国际支付</a></li>
				...
				<ul class="m_left_ulin" id="menu8_10">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 插件管理</li>
					<li id="menu8_10_1"><a href="javascript:;" data-url="Addon/Plugins/Default.aspx">插件列表</a></li>
				</ul>
			</div>
			<div id="menu9" class="m_left_ul">
				<ul class="m_left_ulin" id="menu9_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.OA配置%></li>
					...
					<li id="menu9_1_6"><a href="javascript:;" data-url="WorkFlow/ApplyManage.aspx">公文管理</a></li>
				...
				<ul class="m_left_ulin" id="menu9_2">
					<%--<li class="menu_tit"><i class="fa fa-chevron-down"></i> 组织结构</li> 
				...
				<ul class="m_left_ulin" id="menu9_3">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.项目管理%></li>
...
<%--					<li id="menu9_3_2"><a href="javascript:;" data-url="AddOn/Project/ProjectRequireList.aspx"><%=Resources.L.需求管理%></a></li>--%>
				...
				<ul class="m_left_ulin" id="menu9_4">
                    <li class="menu_tit"><i class="fa fa-chevron-down"></i><%=Resources.L.CRM管理%></li>
<%--                    <li id="menu9_4_2"><a href="javascript:;" data-url="/AdminMVC/CRM/Contact">客户档案</a></li>--%>
                    <li id="menu9_4_1"><a href="javascript:;" data-url="/AdminMVC/CRM/ClientList">客户档案</a></li>
                    <li id="menu9_4_3"><a href="javascript:;" data-url="/AdminMVC/CRM/CType">类别字典</a></li>
					<li id="menu9_4_4"><a href="javascript:;" data-url="Content/Model/ModelField.aspx?ModelID=48&ModelType=11">扩展字段</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu9_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.有问必答%></li>
					<li id="menu9_5_1"><a href="javascript:;" data-url="iServer/BiServer.aspx?num=1"><%=Resources.L.有问必答%></a></li>
					<li id="menu9_5_3"><a href="javascript:;" data-url="iServer/AddQuestionRecord.aspx">创建问题</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu9_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.客服通%></li>
				...
				<ul class="m_left_ulin" id="menu9_7">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.工作统计%></li>
					<li id="menu9_7_1"><a href="javascript:;" data-url="Workload/ContentRank.aspx"><%=Resources.L.排行榜%></a></li>
					<li id="menu9_7_3"><a href="javascript:;" data-url="Workload/WorkCount.aspx">时间统计</a></li>
					<li id="menu9_7_2"><a href="javascript:;" data-url="Workload/Subject.aspx?Type=manager">编辑统计</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu9_8">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.日志管理%></li>
				...
				<ul class="m_left_ulin" id="menu9_9">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.能力中心%></li>
				...
				<ul class="m_left_ulin" id="menu9_11">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.智慧图表%></li>
			...
			<div id="menu10" class="m_left_ul">
				<ul class="m_left_ulin" id="menu10_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.移动应用%></li>
					...
					<li id="menu10_1_4"><a href="javascript:;" data-url="/APP/CLList">APP颁发</a></li>
				...
				<ul class="m_left_ulin" id="menu10_3">
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> 智能硬件</p>
						<ul>
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-downn"></i> 在线监控</p>
						<ul>
							<li id="menu10_3_6"><a href="javascript:;" data-url="Device/Monitor/Default.aspx">设备列表</a></li>
							<li id="menu10_3_7"><a href="javascript:;" data-url="Device/Monitor/MonitorAdd.aspx">添加设备</a></li>
						</ul>
					</li>
				</ul>
				<ul class="m_left_ulin" id="menu10_4">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 消息推送</li>
				...
				<ul class="m_left_ulin" id="menu10_5">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 头条管理</li>
					<li id="menu10_5_1"><a href="javascript:;" data-url="TouTiao/TouTiaoConfig.aspx">头条配置</a></li>
					<li id="menu10_5_3"><a href="javascript:;" data-url="TouTiao/TouTiaoContent.aspx">内容管理</a></li>
					<li id="menu10_5_2"><a href="javascript:;" data-url="TouTiao/AddTouTiaoContent.aspx">发布文章</a></li>
					<li id="menu10_5_4"><a href="javascript:;" data-url="TouTiao/AddTouTiaoVideo.aspx">发布视频</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu10_7">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 百变微站</li>
					<li id="menu10_7_1"><a href="javascript:;" data-url="Amazing/css/default.aspx">呈现管理</a></li>
					<li id="menu10_7_2"><a href="javascript:;" data-url="Amazing/css/csscontent.aspx">新建样式</a></li>
					<li id="menu10_7_3"><a href="javascript:;" data-url="Template/SPage/Default.aspx">可视设计</a></li>
					<li id="menu10_7_4"><a href="javascript:;" data-url="Template/TemplateSetOfficial.aspx">云端模板</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu10_6">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> H5场景</li>
					<div class="input-group">
						<input type="text" placeholder="场景名称或用户名" class="form-control" id="scence_text" />
						<div class="input-group-append">
							<button class="input-group-text" type="button" onclick="ASCX.Search('design/SceneList.aspx?KeyWord=','scence_text');" ><i class="fa fa-search"></i></button>
						</div>
					</div>
					...
					<li class="pl-0"><p class="menu_tit laybtn below"><i class="fa fa-chevron-down"></i> 动力问券</p>
						<ul>
							<li id="menu11_11_6"><a href="javascript:;" data-url="design/ask/asklist.aspx">问券列表</a></li>
			...
			<div id="menu11" class="m_left_ul">
				<ul class="m_left_ulin" id="menu11_1">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.站群管理%></li>
					<li id="menu11_1_1"><a href="javascript:;" data-url="Site/SiteConfig.aspx"><%=Resources.L.全局配置%></a></li>
					<li id="menu11_1_2"><a href="javascript:;" data-url="Site/ServerClusterConfig.aspx">服务器群</a></li>
					<li id="menu11_1_3"><a href="javascript:;" data-url="Site/DBManage.aspx">数据管理</a></li>
					...
					<li id="menu11_1_9"><a href="javascript:;" data-url="Site/HostList.aspx">FTP管理</a></li>
				</ul>
				<ul class="m_left_ulin" id="menu11_2">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> <%=Resources.L.域名注册%></li>
				...
				<ul class="m_left_ulin" id="menu11_10">
					<li class="menu_tit"><i class="fa fa-chevron-down"></i> 动力设计</li>
						<div class="input-group ">
							<input type="text" placeholder="站点名称或用户名" class="form-control" id="site_text" />
							<div class="input-group-append">
								<button class="input-group-text" type="button" onclick="ASCX.Search('design/SiteList.aspx?KeyWord=','site_text');"><i class="fa fa-search"></i></button>
							</div>
						</div>
...
<div class="m_tabs">
		...
		<div class="FrameTab_nav">
			<div id="FrameTabs" style="overflow: hidden; width: 100%;">
				...
				<div class="tab-strip-wrap ">
					<ul class="tab-strip pull-left" id="tab_ul" style="position: fixed;">
						<li class="current first" id="iFrameTab1"><a href="javascript:"><span id="frameTabTitle"><%=Resources.L.新选项卡%></span></a><a class="closeTab" title="关闭"><i class="fa fa-remove"></i></a></li>
						<li class="end addnav" id="newFrameTab"><a title="<%=Resources.L.新选项卡%>" href="javascript:"><i class="fa fa-plus"></i></a></li>
					</ul>
	...
	<div class="thumbnail">
		<div id="main_right_frame">
			<iframe id="main_right" onload="SetTabTitle(this)" style="z-index: 2; background: #fff; visibility: inherit; overflow: auto; overflow-x: hidden; width: 100%;" name="main_right" src="<%=SiteConfig.SiteOption.Admin_StartUrl %>" frameborder="0" tabid="1"></iframe>
...
<div class="manage_mobilemenu">
	<div class="manage_mobilemenu_close"><a href="javascript:;" onclick="HideManageLeft();"><i class="fa z01-icon107"></i> </a></div>
	<div class="manage_mobilemenu_c">
		<ul>
			<li><a href="/" target="_blank" title="网站首页"><i class="fa fa-home"></i> 网站首页</a></li>
			<li><a href="/user/" target="_target" title="ALT+U<%=Resources.L.进入会员中心 %>"><i class="fa fa-user"></i> 会员中心</a></li>
			<li><a href="javascript:void(0)" style="cursor: pointer;" title='Alt+Q<%=Resources.L.锁定屏幕 %>' onclick="showWindow('Lockin.aspx',900,460);"><i class="fa fa-lock"></i> <%=Resources.L.锁定屏幕 %></a></li>
			<li><a href="/AdminMVC/COM/Logout" title="退出系统"><i class="fa z01-icon153"></i> 退出系统</a></li>
		</ul>
	</div>
</div>
