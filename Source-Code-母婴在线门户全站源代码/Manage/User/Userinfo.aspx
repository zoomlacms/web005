...
<tr>
    ...
    <tr>
        <th class="text-right">CRM客户</th>
        <td colspan="3">
            <div runat="server" id="crm_exist" visible="false">
                <a class="btn btn-outline-info" href="/AdminMVC/CRM/ClientAdd?ID=<%:clientMod.ID %>">查看详情</a>
            </div>
            <div runat="server" id="crm_none" visible="false">
                <asp:Button runat="server" ID="UPClient_Btn" Text="升级为客户" class="btn btn-sm btn-outline-info" OnClick="UPClient_Btn_Click"/>
            </div>
...
<a href="UserModify.aspx?UserID=<%=UserID %>" class="btn btn-outline-info" title="修改信息"><i class="fa fa-pencil"></i> 修改资料</a>
